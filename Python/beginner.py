...
# 4. bisect: 이진탐색(Binary Search (이진 탐색)) 기능을 제공하는 라이브러리
...
# * Counter : 중복된 데이터가 저장된 배열을 인자로 넘기면, 각 원소가 몇번씩 나오는지 저장된 객체를 얻음 => dict 형태
from collections import Counter

print("Counter:", Counter(["hi", "hey", "hi", "hi", "hello", "hey"]))
# 결과: Counter: Counter({'hi': 3, 'hey': 2, 'hello': 1})
